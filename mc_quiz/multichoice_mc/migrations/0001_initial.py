...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='MCQuestion',
            fields=[
                ('question_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='quiz_mc.question')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('question', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='multichoice_mc.mcquestion', verbose_name='Question')),
            ],
            options={
                'verbose_name': 'Answer',
