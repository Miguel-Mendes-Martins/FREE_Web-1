# Generated by Django 3.2.13 on 2023-04-17 19:04
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('free', '0042_alter_result_result_type'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('sub_category', models.CharField(choices=[('CREATE', 'Create'), ('FETCH', 'Fetch')], max_length=6)),
