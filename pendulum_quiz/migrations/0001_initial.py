# Generated by Django 3.2.13 on 2023-04-15 14:47
...
import pendulum_quiz.models.quiz_models
import re
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('free', '0038_alter_result_result_type'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('apparatus_protocol', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='pendulum_quiz_category_apparatus_protocol', to='free.protocol', verbose_name='Apparatus Protocol')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='pendulum_quiz_question_category', to='pendulum_quiz.category', verbose_name='Category')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='pendulum_quiz_quiz_category', to='pendulum_quiz.category', verbose_name='Category')),
            ],
            options={
                'verbose_name': 'Quiz',
        ...
        migrations.CreateModel(
            name='Essay_Question',
            fields=[
                ('question_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='pendulum_quiz.question')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='pendulum_quiz_subcategory_category', to='pendulum_quiz.category', verbose_name='Category')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('decimal_precision', models.PositiveIntegerField(default=pendulum_quiz.models.quiz_models.Sitting.randomize_decimal_precision, verbose_name='Decimal Precision')),
                ('execution', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='pendulum_quiz_sitting_execution', to='free.execution', verbose_name='Execution')),
                ('quiz', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='pendulum_quiz_sitting_quiz', to='pendulum_quiz.quiz', verbose_name='Quiz')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='pendulum_quiz_sitting_user', to=settings.AUTH_USER_MODEL, verbose_name='User')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='question',
            name='quiz',
            field=models.ManyToManyField(blank=True, to='pendulum_quiz.Quiz', verbose_name='Quiz'),
        ),
        migrations.AddField(
            model_name='question',
            name='sub_category',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='pendulum_quiz_question_subcategory', to='pendulum_quiz.subcategory', verbose_name='Sub-Category'),
        ),
        migrations.CreateModel(
            name='Progress',
            fields=[
                ...
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='pendulum_quiz_progress_user', to=settings.AUTH_USER_MODEL, verbose_name='User')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('question', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='pendulum_quiz_answer_question', to='pendulum_quiz.mcquestion', verbose_name='Question')),
            ],
            options={
                'verbose_name': 'Answer',
