...
import quiz_pendulum.quiz_structure.models
import re
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('apparatus_protocol', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='quiz_structure_category_apparatus_protocol', to='free.protocol', verbose_name='Apparatus Protocol')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='quiz_structure_quiz_category', to='quiz_structure.category', verbose_name='Category')),
            ],
            options={
                'verbose_name': 'Quiz',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='quiz_structure_subcategory_category', to='quiz_structure.category', verbose_name='Category')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('decimal_precision', models.PositiveIntegerField(default=quiz_pendulum.quiz_structure.models.Sitting.randomize_decimal_precision, verbose_name='Decimal Precision')),
                ('execution', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='quiz_structure_sitting_execution', to='free.execution', verbose_name='Execution')),
                ('quiz', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='quiz_structure_sitting_quiz', to='quiz_structure.quiz', verbose_name='Quiz')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='quiz_structure_sitting_user', to=settings.AUTH_USER_MODEL, verbose_name='User')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='quiz_structure_question_category', to='quiz_structure.category', verbose_name='Category')),
                ('quiz', models.ManyToManyField(blank=True, to='quiz_structure.Quiz', verbose_name='Quiz')),
                ('sub_category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='quiz_structure_question_subcategory', to='quiz_structure.subcategory', verbose_name='Sub-Category')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='quiz_structure_progress_user', to=settings.AUTH_USER_MODEL, verbose_name='User')),
            ],
            options={
